...
public class ContasApagarBean implements Serializable {
	...
	private void carregarLista() throws SQLException {
		...
		listaFinanceiros = listaService.contasApagar(idAuto);
		pesquisarFinanceiros = listaService.contasApagar(idAuto);
	}
	...
	public void gerarRelatorio() {
		...
		try {
			...
			listaFinanceiros = listaService.retornoApagar(idAuto);

			String caminho = Constantes.CAMINHO_FISICO_BASE_WEBAPP + "resources/relatorios/Apagar.jrxml";
	...
	public void gerarRecibo() {
		...
		try {
			...
			/*
			 * Long idRecibo = financeiroSelecionado.getId(); HashMap<String,
			 * Object> parametros = new HashMap<String, Object>();
			 * listaFinanceiros = financeiroService.retornoIdRecibo(idRecibo);
			 * relatorioService.gerarRecibo(listaFinanceiros, parametros,
			 * "recibo");
			 */
	...
	private void carregarValor() throws SQLException {
		...
		apagar = listaService.getTotalApagar(idAuto);
	}
