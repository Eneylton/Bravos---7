...
public class DespesaBean implements Serializable {
	...
	private void carregarLista() throws SQLException {
		...
		listaFinanceiros = listaService.retornoDespesa(idAuto);
		pesquisarFinanceiros = listaService.retornoDespesa(idAuto);
	}
	...
	public void gerarRelatorio() {
		...
		try {
			...
			listaFinanceiros = financeiroService.retorDespesas(idAuto);

			String caminho = Constantes.CAMINHO_FISICO_BASE_WEBAPP + "resources/relatorios/ReletorioDespesas.jrxml";
	...
	private void carregarValor() throws SQLException {
		...
		despesa = listaService.getTotalDespesa(idAuto);
	}
